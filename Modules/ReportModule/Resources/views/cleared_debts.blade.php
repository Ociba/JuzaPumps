                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                           @foreach($get_all_client_with_cleared_debts as $i =>$riders)
                                            <tr>
                                            @php
                                                if( $get_all_client_with_cleared_debts->currentPage() == 1){
                                                    $i = $i+1;
                                                }else{
                                                    $i = ($i+1) + 10*($get_all_client_with_cleared_debts->currentPage()-1);
                                                }
                                            @endphp
                                            <th scope="row">{{$i}}</th> 
                                ...
                                <div class="row">
                                    <div class="text-end ml-2">
                                        {{$get_all_client_with_cleared_debts->links()}}
                                    </div>
                                </div>
                            </div>
                        </div>
