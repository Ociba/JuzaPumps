                ...
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-body">
                                ...
                                <div class=" col-lg-4">
                                   <form action="/clientmodule/search-todays-client" method="get">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                           @foreach($get_todays_riders as $i =>$riders)
                                            <tr>
                                            @php
                                                if( $get_todays_riders->currentPage() == 1){
                                                    $i = $i+1;
                                                }else{
                                                    $i = ($i+1) + 10*($get_todays_riders->currentPage()-1);
                                                }
                                            @endphp
                                            <th scope="row">{{$i}}</th> 
