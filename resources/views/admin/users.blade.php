                                        ...
                                        <tbody>
                                           @foreach($get_users as $i =>$user)
                                            ...
                                            <th scope="row">{{$i}}</th> 
                                                ...
                                                <td>
                                                    <a href="/delete/{{$user->id}}" class="btn btn-danger btn-sm mb-1 waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Delete User Permanently">Delete</a>
                                                </td>
                                                @endif
                                            </tr>
                                            @endforeach
