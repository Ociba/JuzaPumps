                    ...
                    <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-subtitle mb-3 text-info">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            The Selected User is {{$user->name}}
                                        </div> 
                                        <div class="col-lg-4"></div>
                                        <div class="col-lg-4 text-end ml-2">
                                            <div class="text-end ml-2">
                                                <a href="/get-permissions/{{request()->route()->user_id}}" class="btn btn-info btn-sm">Add Permission (s)</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                           @foreach($get_permissions_for_this_user as $i =>$permissions)
                                            <tr>
                                            @php
                                            ...
                                            <th scope="row">{{$i}}</th> 
                                                ...
                                                <td>
                                                    <a href="/delete-permission/{{$permissions->id}}" class="btn btn-info btn-sm mb-1 waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Delete Permission From This User Permanently">Remove</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
