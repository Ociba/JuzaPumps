                                        ...
                                        <tbody>
                                           @foreach($get_users as $i =>$user)
                                            ...
                                            <th scope="row">{{$i}}</th> 
                                                <td>{{$user->name}}</td> 
                                                <td>
                                                    <a href="/user-and-permissions/{{$user->id}}" class="btn btn-info btn-sm mb-1 waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Assign Permissions To This User">Assign | Remove Permision</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
